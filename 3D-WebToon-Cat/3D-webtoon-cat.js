...
function renderAllShapes(){
  ...
  //left_leg.render();
  //var t_circle = new Circle();
  //t_circle.render();
  //var t_sphere = new Sphere();
  //t_sphere.color[.5,.5,.5,1.0];
  //t_sphere.render();
